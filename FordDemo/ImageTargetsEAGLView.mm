...
- (void)renderFrameQCAR
{
    ...
    for (int i = 0; i < state.getNumTrackableResults(); ++i) {
        ...
        if (offTargetTrackingEnabled) {
            ...
            glVertexAttribPointer(vertexHandle, 3, GL_FLOAT, GL_FALSE, 0, (const GLvoid*)layer_1Vertices);
            glVertexAttribPointer(normalHandle, 3, GL_FLOAT, GL_FALSE, 0, (const GLvoid*)layer_1Normals);
            glVertexAttribPointer(textureCoordHandle, 2, GL_FLOAT, GL_FALSE, 0, (const GLvoid*) layer_1TexCoords );
        ...
        if (offTargetTrackingEnabled) {
            ...
            glDrawElements(GL_TRIANGLES, NUM_LAYER_1_OBJECT_INDEX, GL_UNSIGNED_SHORT, (const GLvoid*)layer_1Indices);
        }
